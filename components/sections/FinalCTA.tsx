    ...
    <section className="py-20 bg-gradient-to-br from-primary via-primary to-primary/80 relative overflow-hidden rounded-3xl mx-4 my-10 shadow-2xl">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          {/* Changed from Button to Link to resolve TypeScript href error */}
          <Link
            href="/generate"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4">
            {[
              ...
              <Card
                key={idx}
                className="bg-card border-border hover:shadow-md transition-all duration-300 group cursor-pointer"
              >
