  ...
  async function handleSubmit(formData: FormData) {
    startTransition(async () => {
      ...
      if (result?.error) {
        ...
        // The 'login' action handles the redirect to /dashboard
      }
    });
  }
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button 
                ...
                className="flex items-center justify-center py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 dark:border-gray-600 dark:text-white dark:hover:bg-gray-700 transition-colors"
              >
                <img className="w-5 h-5 mr-2 dark:invert" src="https://www.svgrepo.com/show/511330/apple-fill.svg" alt="apple" />
            ...
            <div className="flex items-center my-4">
              ...
              <span className="px-3 text-xs text-gray-500 uppercase">Or email login</span>
              <div className="flex-grow border-t border-gray-300 dark:border-gray-600"></div>
            </div>
            ...
            <form className="space-y-4 md:space-y-6" action={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember" className="ml-2 text-sm text-gray-500 dark:text-gray-300 cursor-pointer">Remember me</label>
                </div>
